    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-grow bg-white-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-7xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            <h1 className="text-3xl font-bold mb-4">Terms and Conditions</h1>
            <p className="text-gray-500 dark:text-gray-400 mb-6">Last updated: April 16, 2025</p>
            ...
            <ul className="list-disc pl-6 mb-8 space-y-3">
              ...
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to A2A Protocol.</p>
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 mb-8">
              <li>By email: <a href="mailto:a2aprotocal@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">a2aprotocal@gmail.com</a></li>
            </ul>
