        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="prose max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to A2A Protocal.</li>
              ...
              <li><strong>Website</strong> refers to A2A Protocal, accessible from https://www.a2aprotocal.com</li>
            ...
            <h4 className="text-lg font-semibold text-gray-900 mt-4 mb-2">We use both Session and Persistent Cookies for the purposes set out below:</h4>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Transfer of Your Personal Data</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Delete Your Personal Data</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Disclosure of Your Personal Data</h2>
            ...
            <p className="mb-4">
              By email: <a href="mailto:a2aprotocal@gmail.com" className="text-blue-600 hover:text-blue-800">a2aprotocal@gmail.com</a>
            </p>
          </div>
        </div>
      </div>
